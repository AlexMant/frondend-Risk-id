...
@Component({
  selector: 'app-list-hardware-new-user',
  templateUrl: './list-hardware-new-user.component.html',
  styleUrls: ['./list-hardware-new-user.component.css']
})
export class ListHardwareNewUserComponent implements OnInit , OnDestroy {
