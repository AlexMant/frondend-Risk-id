...
import { SubMenueditSolicitudUserListService } from './sub-menueditsolicitud-user-list.service';
import { TableHeadInterface } from 'src/app/core/interfaces/tableHead.model';
import { ActionInterface } from 'src/app/core/interfaces/action.model';
@Component({
  selector: 'app-solicitud-user-edit',
  templateUrl: './solicitud-user-edit.component.html',
  styleUrls: ['./solicitud-user-edit.component.css']
})
export class SolicitudUserEditComponent implements OnInit {
