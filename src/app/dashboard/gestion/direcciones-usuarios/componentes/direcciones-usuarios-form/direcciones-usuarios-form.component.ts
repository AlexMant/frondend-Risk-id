...
@Component({
  selector: 'app-direcciones-usuarios-form',
  templateUrl: './direcciones-usuarios-form.component.html',
  styleUrls: ['./direcciones-usuarios-form.component.css']
})
export class DireccionesUsuariosFormComponent implements OnInit {
  @Input() modelo: any;
