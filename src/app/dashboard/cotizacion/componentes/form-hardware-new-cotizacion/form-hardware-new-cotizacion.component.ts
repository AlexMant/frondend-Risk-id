...
@Component({
  selector: 'app-form-hardware-new-cotizacion',
  templateUrl: './form-hardware-new-cotizacion.component.html',
  styleUrls: ['./form-hardware-new-cotizacion.component.css']
})
export class FormHardwareNewCotizacionComponent implements OnInit  {
