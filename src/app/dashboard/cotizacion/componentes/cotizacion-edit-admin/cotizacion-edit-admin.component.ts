...
import { ModalAdminAsignacionUserComponent } from 'src/app/dashboard/solicitud-admin/componentes/modal-admin-asignacion-user/modal-admin-asignacion-user.component';
import { ModalGenerarCotizacionComponent } from 'src/app/dashboard/solicitud-admin/componentes/modal-generar-cotizacion/modal-generar-cotizacion.component';
import { ModalSolicitaRetiroComponent } from 'src/app/dashboard/solicitud-admin/componentes/modal-solicita-retiro/modal-solicita-retiro.component';
...
@Component({
  selector: 'app-cotizacion-edit-admin',
  templateUrl: './cotizacion-edit-admin.component.html',
  styleUrls: ['./cotizacion-edit-admin.component.css']
})
export class CotizacionEditAdminComponent implements OnInit , OnDestroy {
  ...
  guardar() {
    ...
    if (estado == 3) {
      ...
      if(  this.vmP.documentosSolicitud.length == 0){
        this.snackbar.notify('danger', 'Debe agregar al menos un documento para poder cerrar');
        return;
      }
    ...
    this.dialog
      .open(ConfirmModalComponent, {
        ...
        data: {
          ...
          titleventana: 'Actualizar Cotización',
          message: '¿Seguro que desea actualizar la cotización a '+this.desestadosolicitud(estado)+'?',
          btnText: 'Si, Seguro',
        ...
        if (res) {
          ...
          this.solicitudService.updateestadosolicitud(bodypaso3).subscribe(
            ...
            (err) => {
              ...
              this.snackbar.notify('danger', 'Error al actualizar la cotización');
  ...
  enviaMail() {
    ...
    let modeloMail = {
      ...
      subtitulo: "Se ha cerrado una cotización",
      textouno: "" + this.nombreusuario + ", se ha cerrado su cotización con el código  " + this.vcodigosolicitud + ".",
      textodos: "Equipo RISK-ID. ",
      linkboton: "",
      Asunto: "Cierre de cotización",
