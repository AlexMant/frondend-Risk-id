...
@Component({
  selector: 'app-list-hardware-new-cotizacion',
  templateUrl: './list-hardware-new-cotizacion.component.html',
  styleUrls: ['./list-hardware-new-cotizacion.component.css']
})
export class ListHardwareNewCotizacionComponent implements OnInit  , OnDestroy {
